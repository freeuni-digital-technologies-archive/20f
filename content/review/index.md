...
- სემინარი: ხანის აკადემიაზე DOM javascript-ის კითხვების განხილვა. 
...
- სემინარი: დავალების გარჩევა. [ვებ აპლიკაცია: ნაწილი მეორე](/content/classwork/13_webapp1)
- ინფორმაცია ფინალური პროექტის შესახებ იქნება მომავალ კვირას
- ორშაბათის შემდეგ ბევრმა გამოთქვა ბონუს პრეზენტაციის სურვილი. რადგან მხოლოდ ორი შეხვედრა დაგვრჩა, შევეცდები რამე ალტერნატივა მოვიფიქრო.
